    ...
    <div className="items-center justify-items-center min-h-screen">
      ...
      <div className="h-auto w-auto bg-linear-to-r from-red-500 to-blue-600 justify-items-center rounded-xl p-8 m-14">
        <dd className="text-white font-medium font-mono mt-4 ">
            Astro cat is my survival game. You play as a cat and you have to put in effort to do things but the game won't help you. You can make it a slower game or a faster pase game.
            Astro cat was developed in Unity 2022.3.14f1. Its still in development.
        </dd>
        <button className="mt-8 bg-linear-to-r from-purple-900 to-emerald-950 h-24 w-48 hover:from-purple-600 hover:to-emerald-500 rounded-xl" onClick={() => router.push('https://puggamedev.itch.io/astro-cat')}>
